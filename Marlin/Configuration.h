...
#define STRING_CONFIG_H_AUTHOR "(mkj)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Flinger"
...
#define Y_BED_SIZE 274

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS -(5 + X_BED_SIZE/2)
#define Y_MIN_POS -(2 + Y_BED_SIZE/2)
#define Z_MIN_POS 0
